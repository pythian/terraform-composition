...
[[ -z ${MREGION} ]] && exit_with_msg "-m|--multiregion is a required parameter. Exiting."
...
echo "Multiregion Location: ${MREGION}"
...
sed -i -e "s:MREGION:${MREGION}:g" env.yaml
