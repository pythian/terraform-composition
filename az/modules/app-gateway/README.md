...
| <a name="input_probes"></a> [probes](#input\_probes) | Probes to be added to the application gateway | <pre>map(object({<br/>    host                                = optional(string, null)<br/>    interval                            = optional(number, 30)<br/>    path                                = optional(string, "/")<br/>    pick_host_name_from_backend_address = optional(bool, true)<br/>    port                                = optional(number, null)<br/>    protocol                            = optional(string, "Https")<br/>    timeout                             = optional(number, 30)<br/>    unhealthy_threshold                 = optional(number, 3)<br/>  }))</pre> | `{}` | no |
