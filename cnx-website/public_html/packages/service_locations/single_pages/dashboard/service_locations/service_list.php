...
<div class="ccm-pane-body">
  ...
  <form method="get" action="<?php  echo $this->action('view')?>">
    ...
    <table class="ccm-results-list table">
      ...
      <tr>
        <td><?php  echo $form->select('cParentID', $sections, isset($cParentID)?$cParentID:0)?></td>
        <td><?php  echo $form->text('like', isset($like)?$like:'')?></td>
        <td><?php  echo $form->submit('submit', t('Search'), array('class'=>'btn-primary'))?></td>
      </tr>
    </table>
  </form>
  <br/>
