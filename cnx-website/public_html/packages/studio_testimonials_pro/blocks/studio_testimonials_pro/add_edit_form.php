...
<div id="settings" style="padding: 10px;">
	...
	<?php    echo $form->hidden('testimonial_ids', isset($testimonial_ids)?$testimonial_ids:''); ?>

	<div class="form-group">
		<?php    echo $form->label('title', t('Title')); ?>
		<div class="controls">
		<?php    echo $form->text('title', isset($title)?$title:'', array('class'=>'span4')); ?>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="controls">
				<?php    echo $form->select('display_type', $type_options,  isset($display_type)?$display_type:''  ,array('class' => 'span4'));?>

				<div class="well" style="margin: 10px 0 0; width: 290px; display: none;" id="multiple-options" >
					<span><?php    echo t('# to display'); ?></span>
					<?php    echo $form->text('number',  isset($number)?$number:0, array('class'=>'span1')); ?>
					<span class="small text-muted"><?php   echo t('Enter 0 to display all') ?></span>

					<div id="paging-options" style="margin-top: 10px">
						<div class="checkbox">
						<label>
						<?php    echo $form->checkbox('pagination', '1',  isset($pagination)?$pagination:0); ?>
					...
					<div id="rotate-options" style="display:none">
						<div style="margin-top: 10px;">
							...
							<?php    echo $form->text('rotate_length',  isset($rotate_length)?$rotate_length:'',  array('style' => 'width: 100px'));?>
							<div class="help-inline text-muted"><?php    echo t('In milliseconds.')?></div>
						</div>
						<div style="margin-top: 10px;">
							<span><?php    echo t('Effect'); ?></span>
							<?php    echo $form->select('effect', array('fade'=>t('Fade'), 'slide'=>t('Slide')),  isset($effect)?$effect:'', array('style'=>'width: 100px'));?>
						</div>
					</div>
				</div>
		</div>
	...
	<div class="form-group">
		...
		<div class="controls">
				<?php    echo $form->select('display', $display_options,  isset($display)?$display:'' ,array('class' => 'span4'));?>
	...
	<div class="form-group">
		...
		<div class="controls">
				<?php    echo $form->select('sort', $sort_options,  isset($sort)?$sort:'' ,array('class' => 'span4'));?>
		</div>
	</div>
...
<div id="advanced" style="padding: 10px; display: none;">
	...
	<div class="form-group">
		<div class="checkbox">
			<label> <?php   echo $form->checkbox('display_image', '1',  isset($display_image)?$display_image:0); ?> <?php    echo t('Display Image'); ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="controls">
			<div class="row form-inline">
				<div class="col-sm-4">
				<?php    echo $form->text('image_width',  isset($image_width)?$image_width:''); ?>
				<div class="help-block"><?php    echo t('(width)'); ?></div>
				</div>
				<div class="col-sm-4">
				<?php    echo $form->text('image_height',  isset($image_height)?$image_height:''); ?>
	...
	<div class="well">
		<div class="form-group" style="margin-top: 10px;">
			<div class="checkbox">
				<label>
				<input type="checkbox" value="1" name="enable_submit" <?php    if( isset($enable_submit)){ echo 'checked'; } ?>>
		...
		<div class="form-group">
			...
			<?php    echo $form->text('submit_link_text',  isset($submit_link_text)?$submit_link_text:''); ?>
		</div>
		...
		<div class="form-group">
			...
			<div class="input-group">
				<span class="input-group-addon">
					<?php    echo $form->checkbox('notify_on_submission', '1',  isset($notify_on_submission)?$notify_on_submission:0, array('onclick' => "$('input[name=recipient_email]').focus()")); ?>
				</span>
				<?php    echo $form->text('recipient_email',  isset($recipient_email)?$recipient_email:''); ?>
			</div>
		</div>
	</div>
...
$(function(){
	...
	$("#select-testimonials-btn").click(function(e){
		e.preventDefault();
		  ...
		  href: CCM_APPLICATION_URL+"<?php    echo '/index.php/tools/select_testimonials'?>",
		  width: 450,
		  modal: false,
		  height: 380
	   	});
