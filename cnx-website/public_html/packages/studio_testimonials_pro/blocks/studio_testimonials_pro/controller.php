...
class Controller extends BlockController {
		...
		public $category;
		public $enable_submit;
		public $display_type;
		public $rotate_length;
		public $effect;
		public $display;
		public $testimonial_ids;
		public $number;
		public $sort;
		public $pagination;
		public $notify_on_submission;
		...
		public function view(){
			if($this->enable_submit){
				...
				$this->addHeaderItem('<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/magnific-popup.min.css" integrity="sha512-+EoPw+Fiwh6eSeRK7zwIKG2MA8i3rV/DGa3tdttQGgWyatG/SkncT53KHQaS5Jh9MNOT3dmFL0FjTY08And/Cw==" crossorigin="anonymous" referrerpolicy="no-referrer" />');
				$this->addFooterItem('<script src="//cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.min.js" integrity="sha512-IsNh5E3eYy3tr/JiX2Yx4vsCujtkhwl7SLqgnwLNgf04Hrt9BT9SXlLlZlWx+OK4ndzAoALhsMNcCmkggjZB1w==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>');
				$this->addFooterItem('
				<script>
				$(function(){
    ...
    return this.each(function(){
      ...
      setInterval(function(){
		...
		public function save($data){
			...
			$data['number'] = isset($data['number'])?intval($data['number']):0;
			$data['rotate_length'] = isset($data['rotate_length'])?intval($data['rotate_length']):0;
			$data['display_image'] = isset($data['display_image'])?intval($data['display_image']):0;
			...
			$data['pagination'] = isset($data['pagination'])?intval($data['pagination']):0;
			$data['page_size'] = isset($data['page_size'])?intval($data['page_size']):0;
			$data['enable_submit'] = isset($data['enable_submit'])?intval($data['enable_submit']):0;
			$data['notify_on_submission'] = isset($data['notify_on_submission'])?intval($data['notify_on_submission']):0;

			if($data['rotate_length'] < 100){
				$data['rotate_length'] = 3000;
			}

			$data['category'] = isset($data['category'])?serialize($data['category']):'';
