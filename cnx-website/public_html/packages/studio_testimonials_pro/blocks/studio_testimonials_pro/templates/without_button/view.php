...
<div class="st-pro-rotating" id="studio-testimonials-<?php    echo $bID; ?>">
		...
		<ul class="st-pro-ticker">
			<?php    foreach($testimonials as $testimonial){ ?>
				...
				<div class="st-pro-testimonial">
					...
					<?php    if($testimonial->video > 0):
						$video = File::getByID($testimonial->video);
					...
					<div class="st-pro-content"><p><?php  echo nl2br(Loader::helper('text')->shorten($testimonial->content,170)); ?></p></div>
...
<hr>
<form method="post" action="<?php echo BASE_URL.'/index.php/tools/submit_testimonial'?>" id="submit-testimonial-form">
    <?php   echo $form->hidden('bID', $bID ); ?>

	<div class="form-group">
        <?php    echo $form->label('author', t('Name'))?>
        <div class="controls"><?php    echo $form->text('author', isset($author)?$author:'', array('maxlength'=>200))?></div>
    </div>
    <div class="form-group">
        <?php    echo $form->label('content', t('Content'))?>
        <div class="controls"><textarea class="form-control" name="content" id="testimonial-content"><?php    echo isset($testimonial_content)?$testimonial_content:'' ?></textarea></div>
    </div>
    <div class="form-group">
        <?php    echo $form->label('extra', t('Extra'))?>
        <div class="controls"><?php    echo $form->textarea('extra',isset($extra)?$extra:'')?></div>
