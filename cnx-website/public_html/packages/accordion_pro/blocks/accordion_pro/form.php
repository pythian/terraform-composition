        ...
        <div class="extendedContent">
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $html = str_replace("class=\"form-control\"", "", $html);
            ...
            <a href="javascript:void(0);" class="btn btn-secondary" onclick="return accordionPro.backend.collapseItems();">
...
<div id="titems" class="tab-pane active">
...
<div id="toptions" class="tab-pane" role="tabpanel">

    <div class="form-group">

        <?php echo $form->label("stylePresetId", t("Style Preset")); ?>

        <?php echo $form->select("stylePresetId", $stylePresets, isset($stylePresetId)?$stylePresetId:''); ?>
    ...
    <div class="form-group">
        ...
        <?php echo $form->select("collapse", array(0 => t("No"), 1 => t("Yes")), isset($colapse)?$colapse:1); ?>
    ...
    <div class="form-group">
        ...
        <?php echo $form->select("scrollToActiveItem", array(0 => t("No"), 1 => t("Yes")), isset($scrollToActiveItem)?$scrollToActiveItem:0); ?>
    ...
    <div class="form-group">
        ...
        <?php echo $form->select("semanticTag", array("h2" => "h2", "h3" => "h3", "h4" => "h4", "h5" => "h5", "h6" => "h6"), isset($semanticTag)?$semanticTag:''); ?>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <?php echo $form->number("animationDuration", isset($animationDuration) ? $animationDuration:300); ?>
