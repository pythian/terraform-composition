        ...
        <div class="js-tab-pane tab-pane" id="entries-tab-<?php echo $uniqueID; ?>">
            ...
            <script type="text/template" class="js-entry-template">
                ...
                <div class="well entry js-entry" data-position="<%=_.escape(position)%>">
                    ...
                    <div class="entry-content js-entry-content" <% if (keepAddedEntryCollapsed) { %>style="display: none;"<% } %>>
                        ...
                        <div class="mb-4 js-custom-editor-height-<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][description]-<?php echo $uniqueID; ?>">
                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][description]" class="form-label"><?php echo t('Description'); ?></label>
                            <textarea style="display: none;" class="js-editor-content" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][description]" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][description]"><%=_.escape(description)%></textarea>
                        </div>
            ...
            <script>
                ...
                $(function () {
                    ...
                    Concrete.event.publish('open.block.step-highlight', {
