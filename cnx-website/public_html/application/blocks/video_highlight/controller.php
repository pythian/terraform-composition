<?php namespace Application\Block\VideoHighlight;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btVideoHighlight';
    protected $btExportTables = ['btVideoHighlight'];
    ...
    public function addEdit() {
        ...
        $this->set('link', $this->link);
        $this->set('video_url', $this->video_url);

        // Load form.css
        $al = AssetList::getInstance();
        $al->register('css', 'video-highlight/form', 'blocks/video_highlight/css_files/form.css', [], false);
        $this->requireAsset('css', 'video-highlight/form');
    ...
    public function save($args) {
        ...
        $args['video_url']       = !empty($args['video_url']) ? trim($args['video_url']) : '';
