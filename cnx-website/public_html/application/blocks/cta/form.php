                ...
                <div class="js-additional-image-fields-wrapper-image-<?php echo $uniqueID; ?>" <?php if (empty($image_data['show_additional_fields'])): ?>style="display: none;"<?php endif; ?>>
                    ...
                    <div class="row margin-bottom">
                        <div class="col-12">
                            ...
                            <div class="form-check">
                                <?php echo $form->checkbox($view->field('image_override_dimensions'), '1', $image_data['override_dimensions'] ?? null, ['class' => 'form-check-input js-toggle-override-dimensions-'.$uniqueID]); ?>
                                <label for="<?php echo $view->field('image_override_dimensions'); ?>" class="form-check-label"><?php echo t('Yes'); ?></label>
                            </div>
                        </div>
                        <div class="row mt-3 js-override-dimensions-wrapper-<?php echo $uniqueID; ?>" <?php if (empty($image_data['override_dimensions'])): ?>style="display: none;"<?php endif; ?>>
                            <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                                <?php echo $form->label($view->field('image_custom_width'), t('Width')); ?>
                                <div class="input-group">
                                    <?php echo $form->number($view->field('image_custom_width'), !empty($image_data['custom_width']) ? $image_data['custom_width'] : ''); ?>
                                    <span class="input-group-text"><?php echo t('px'); ?></span>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                                <?php echo $form->label($view->field('image_custom_height'), t('Height')); ?>
                                <div class="input-group">
                                    <?php echo $form->number($view->field('image_custom_height'), !empty($image_data['custom_height']) ? $image_data['custom_height'] : ''); ?>
                                    <span class="input-group-text"><?php echo t('px'); ?></span>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4">
                                <?php echo $form->label($view->field('image_custom_crop'), t('Crop')); ?>
                                <?php echo $form->select($view->field('image_custom_crop'), ['0'=>t('No'), '1'=>t('Yes')], $image_data['custom_crop'] ?? null); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row margin-bottom">
                        <div class="col-12">
                            ...
                            <div class="form-check">
                                <?php echo $form->checkbox($view->field('image_override_fullscreen_dimensions'), '1', $image_data['override_fullscreen_dimensions'] ?? null, ['class' => 'form-check-input js-toggle-override-fullscreen-dimensions-'.$uniqueID]); ?>
                                <label for="<?php echo $view->field('image_override_fullscreen_dimensions'); ?>" class="form-check-label"><?php echo t('Yes'); ?></label>
                            </div>
                        </div>
                        <div class="row mt-3 js-override-fullscreen-dimensions-wrapper-<?php echo $uniqueID; ?>" <?php if (empty($image_data['override_fullscreen_dimensions'])): ?>style="display: none;"<?php endif; ?>>
                            <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                                <?php echo $form->label($view->field('image_custom_fullscreen_width'), t('Width')); ?>
                                <div class="input-group">
                                    <?php echo $form->number($view->field('image_custom_fullscreen_width'), !empty($image_data['custom_fullscreen_width']) ? $image_data['custom_fullscreen_width'] : ''); ?>
                                    <span class="input-group-text"><?php echo t('px'); ?></span>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                                <?php echo $form->label($view->field('image_custom_fullscreen_height'), t('Height')); ?>
                                <div class="input-group">
                                    <?php echo $form->number($view->field('image_custom_fullscreen_height'), !empty($image_data['custom_fullscreen_height']) ? $image_data['custom_fullscreen_height'] : ''); ?>
                                    <span class="input-group-text"><?php echo t('px'); ?></span>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4">
                                <?php echo $form->label($view->field('image_custom_fullscreen_crop'), t('Crop')); ?>
                                <?php echo $form->select($view->field('image_custom_fullscreen_crop'), ['0'=>t('No'), '1'=>t('Yes')], $image_data['custom_fullscreen_crop'] ?? null); ?>
                            </div>
                        </div>
                    </div>
