    ...
    <div class="tab-content mt-4">
        ...
        <div class="js-tab-pane tab-pane show active" id="entries-tab-<?php echo $uniqueID; ?>">
                ...
                <div class="well entry js-entry" data-position="<%=_.escape(position)%>">
                    ...
                    <div class="entry-content js-entry-content" <% if (keepAddedEntryCollapsed) { %>style="display: none;"<% } %>>
                        ...
                        <div class="mb-4 js-image-wrapper">
                            ...
                            <div class="row margin-bottom">
                                <div class="col-12">
                                    <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image]" class="form-label"><?php echo t('Hover Image'); ?></label>
                                </div>
                                <div class="col-12 col-lg-6 margin-bottom-on-mobile">
                                    <div data-concrete-file-input="js-file-selector">
                                        <concrete-file-input :file-id="<%= hover_image ? _.escape(hover_image) : '0' %>"
                                            choose-text="<?php echo t('Choose File'); ?>"
                                            input-name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image]"
                                        ></concrete-file-input>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <span class="toggle-additional-image-fields <% if (parseInt(hover_image_show_additional_fields)) { %>toggle-additional-image-fields-active<% } %> btn btn-secondary js-toggle-additional-image-fields"
                                        data-show-text="<?php echo t('Show additional fields'); ?>"
                                        data-hide-text="<?php echo t('Hide additional fields'); ?>"
                                    ><i class="fas fa-caret-right"></i> <span class="js-toggle-additional-image-fields-text"><% if (parseInt(hover_image_show_additional_fields)) { %><?php echo t('Hide additional fields'); ?><% } else { %><?php echo t('Show additional fields'); ?><% } %></span></span>
                                    <input type="hidden" class="js-toggle-additional-image-fields-value" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_show_additional_fields]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_show_additional_fields]" value="<%=_.escape(hover_image_show_additional_fields)%>" maxlength="255" />
                                </div>
                            </div>

                            <div class="js-additional-image-fields-wrapper" <% if (!parseInt(hover_image_show_additional_fields)) { %>style="display: none;"<% } %>>

                                <div class="mb-4">
                                    <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_alt]" class="form-label"><?php echo t('Alt text'); ?></label>
                                    <input type="text" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_alt]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_alt]" value="<%=_.escape(hover_image_alt)%>" class="form-control" maxlength="255" />
                                </div>
                                ...
                                <div class="row margin-bottom">
                                    <div class="col-12">
                                        <label for="" class="form-label"><?php echo t('Override Thumbnail dimensions'); ?></label>
                                        <div class="form-check">
                                            <input type="checkbox" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_override_dimensions]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_override_dimensions]" class="js-toggle-override-image-dimensions form-check-input" value="<%=parseInt(hover_image_override_dimensions)%>" <% if (parseInt(hover_image_override_dimensions)) { %>checked<% } %> />
                                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_override_dimensions]" class="form-check-label"><?php echo t('Yes'); ?></label>
                                        </div>
                                    </div>
                                    <div class="row mt-3 js-override-image-dimensions-wrapper" <% if (!parseInt(hover_image_override_dimensions)) { %>style="display: none;"<% } %>>
                                        <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_width]" class="form-label"><?php echo t('Width'); ?></label>
                                            <div class="input-group">
                                                <input type="number" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_width]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_width]" value="<% if (parseInt(hover_image_custom_width)) { %><%=_.escape(hover_image_custom_width)%><% } else { %><% } %>" class="form-control ccm-input-number" />
                                                <span class="input-group-text"><?php echo t('px'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_height]" class="form-label"><?php echo t('Height'); ?></label>
                                            <div class="input-group">
                                                <input type="number" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_height]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_height]" value="<% if (parseInt(hover_image_custom_height)) { %><%=_.escape(hover_image_custom_height)%><% } else { %><% } %>" class="form-control ccm-input-number" />
                                                <span class="input-group-text"><?php echo t('px'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_crop]" class="form-label"><?php echo t('Crop'); ?></label>
                                            <select id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_crop]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_crop]" class="form-select">
                                                <option value="0" <% if (!parseInt(hover_image_custom_crop)) { %>selected="selected"<% } %>><?php echo t('No'); ?></option>
                                                <option value="1" <% if (parseInt(hover_image_custom_crop)==1) { %>selected="selected"<% } %>><?php echo t('Yes'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row margin-bottom">
                                    <div class="col-12">
                                        <label for="" class="form-label"><?php echo t('Override Fullscreen Image dimensions'); ?></label>
                                        <div class="form-check">
                                            <input type="checkbox" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_override_fullscreen_dimensions]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_override_fullscreen_dimensions]" class="form-check-input js-toggle-override-fullscreen-image-dimensions" value="<%=parseInt(hover_image_override_fullscreen_dimensions)%>" <% if (parseInt(hover_image_override_fullscreen_dimensions)) { %>checked<% } %> />
                                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_override_fullscreen_dimensions]" class="form-check-label"><?php echo t('Yes'); ?></label>
                                        </div>
                                    </div>
                                    <div class="row mt-3 js-override-fullscreen-image-dimensions-wrapper" <% if (!parseInt(hover_image_override_fullscreen_dimensions)) { %>style="display: none;"<% } %>>
                                        <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_width]" class="form-label"><?php echo t('Width'); ?></label>
                                            <div class="input-group">
                                                <input type="number" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_width]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_width]" value="<% if (parseInt(hover_image_custom_fullscreen_width)) { %><%=_.escape(hover_image_custom_fullscreen_width)%><% } else { %><% } %>" class="form-control ccm-input-number" />
                                                <span class="input-group-text"><?php echo t('px'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_height]" class="form-label"><?php echo t('Height'); ?></label>
                                            <div class="input-group">
                                                <input type="number" id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_height]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_height]" value="<% if (parseInt(hover_image_custom_fullscreen_height)) { %><%=_.escape(hover_image_custom_fullscreen_height)%><% } else { %><% } %>" class="form-control ccm-input-number" />
                                                <span class="input-group-text"><?php echo t('px'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label for="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_crop]" class="form-label"><?php echo t('Crop'); ?></label>
                                            <select id="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_crop]" name="<?php echo $view->field('entry'); ?>[<%=_.escape(position)%>][hover_image_custom_fullscreen_crop]" class="form-select">
                                                <option value="0" <% if (!parseInt(hover_image_custom_fullscreen_crop)) { %>selected="selected"<% } %>><?php echo t('No'); ?></option>
                                                <option value="1" <% if (parseInt(hover_image_custom_fullscreen_crop)==1) { %>selected="selected"<% } %>><?php echo t('Yes'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
            ...
            <script>
                ...
                $(function () {
                    ...
                    Concrete.event.publish('open.block.service-highlight', {
        ...
        <div class="js-tab-pane tab-pane" id="settings-tab-<?php echo $uniqueID; ?>">
            ...
            <div class="mb-4 js-image-settings-wrapper">
                <div class="row margin-bottom">
                    <div class="col-12">
                        <?php echo $form->label('', 'Hover Image' . ' - ' . t('Override Thumbnail dimensions')); ?>
                        <div class="form-check">
                            <?php echo $form->checkbox($view->field('settings[hover_image_override_dimensions]'), '1', $settings['hover_image_override_dimensions'] ?? null, ['class' => 'form-check-input js-toggle-override-all-dimensions']); ?>
                            <label for="<?php echo $view->field('settings[hover_image_override_dimensions]'); ?>" class="form-check-label"><?php echo t('Yes'); ?></label>
                        </div>
                    </div>
                    <div class="row mt-3 js-override-all-dimensions-wrapper" <?php if (empty($settings['hover_image_override_dimensions'])): ?>style="display: none;"<?php endif; ?>>
                        <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                            <?php echo $form->label($view->field('settings[hover_image_custom_width]'), t('Width')); ?>
                            <div class="input-group">
                                <?php echo $form->number($view->field('settings[hover_image_custom_width]'), !empty($settings['hover_image_custom_width']) ? $settings['hover_image_custom_width'] : ''); ?>
                                <span class="input-group-text"><?php echo t('px'); ?></span>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                            <?php echo $form->label($view->field('settings[hover_image_custom_height]'), t('Height')); ?>
                            <div class="input-group">
                                <?php echo $form->number($view->field('settings[hover_image_custom_height]'), !empty($settings['hover_image_custom_height']) ? $settings['hover_image_custom_height'] : ''); ?>
                                <span class="input-group-text"><?php echo t('px'); ?></span>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <?php echo $form->label($view->field('settings[hover_image_custom_crop]'), t('Crop')); ?>
                            <?php echo $form->select($view->field('settings[hover_image_custom_crop]'), ['0'=>t('No'), '1'=>t('Yes')], $settings['hover_image_custom_crop'] ?? null); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4 js-fullscreen-image-settings-wrapper">
                <div class="row margin-bottom">
                    <div class="col-12">
                        <?php echo $form->label('', 'Hover Image' . ' - ' . t('Override Fullscreen Image dimensions')); ?>
                        <div class="form-check">
                            <?php echo $form->checkbox($view->field('settings[hover_image_override_fullscreen_dimensions]'), '1', $settings['hover_image_override_fullscreen_dimensions'] ?? null, ['class' => 'form-check-input js-toggle-override-all-fullscreen-dimensions']); ?>
                            <label for="<?php echo $view->field('settings[hover_image_override_fullscreen_dimensions]'); ?>" class="form-check-label"><?php echo t('Yes'); ?></label>
                        </div>
                    </div>
                    <div class="row mt-3 js-override-all-fullscreen-dimensions-wrapper" <?php if (empty($settings['hover_image_override_fullscreen_dimensions'])): ?>style="display: none;"<?php endif; ?>>
                        <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                            <?php echo $form->label($view->field('settings[hover_image_custom_fullscreen_width]'), t('Width')); ?>
                            <div class="input-group">
                                <?php echo $form->number($view->field('settings[hover_image_custom_fullscreen_width]'), !empty($settings['hover_image_custom_fullscreen_width']) ? $settings['hover_image_custom_fullscreen_width'] : ''); ?>
                                <span class="input-group-text"><?php echo t('px'); ?></span>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4 margin-bottom-on-mobile">
                            <?php echo $form->label($view->field('settings[hover_image_custom_fullscreen_height]'), t('Height')); ?>
                            <div class="input-group">
                                <?php echo $form->number($view->field('settings[hover_image_custom_fullscreen_height]'), !empty($settings['hover_image_custom_fullscreen_height']) ? $settings['hover_image_custom_fullscreen_height'] : ''); ?>
                                <span class="input-group-text"><?php echo t('px'); ?></span>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <?php echo $form->label($view->field('settings[hover_image_custom_fullscreen_crop]'), t('Crop')); ?>
                            <?php echo $form->select($view->field('settings[hover_image_custom_fullscreen_crop]'), ['0'=>t('No'), '1'=>t('Yes')], $settings['hover_image_custom_fullscreen_crop'] ?? null); ?>
                        </div>
                    </div>
                </div>
            </div>
