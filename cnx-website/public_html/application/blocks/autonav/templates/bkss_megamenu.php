            ...
            $sub_content.='</li>';
                        ...
                        <div class="meganav-right">
                            ...
                            <div class="meganav-def-cont">
                                ...
                                <?= ($ni->cObj->getAttribute('mega_nav_content')) ? $ni->cObj->getAttribute('mega_nav_content') : ''; ?>
...
if($('.list-cont-'+$(this).data('id')).length){
    $('.meganav-list-cont').hide();
    $('.list-cont-'+$(this).data('id')).fadeIn();
}else{
    $('.meganav-list-cont').fadeOut();
}

        });

        $('li.has-meganav').hover(function(){
            if($('.mega_item.nav-selected',this).length>0){

        if($('.list-cont-'+$('.mega_item.nav-selected',this).data('id')).length){
                $('.meganav-list-cont').hide();
                $('.list-cont-'+$('.mega_item.nav-selected',this).data('id')).fadeIn();
        }else{
            $('.meganav-list-cont').fadeOut();
        }

    }else{
          if($('.mega_item',this).first().html()!=''){
            if($('.list-cont-'+$('.mega_item',this).first().data('id')).length){
                $('.meganav-list-cont').hide();
                $('.list-cont-'+$('.mega_item',this).first().data('id')).fadeIn();
        }else{
            $('.meganav-list-cont').fadeOut();
        }
          }
