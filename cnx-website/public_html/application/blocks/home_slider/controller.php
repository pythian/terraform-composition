...
class Controller extends BlockController
{
    ...
    protected $btExportTables = ['btHomeSlider', 'btHomeSliderEntries'];
    ...
    public function addEdit() {
        ...
        $al->register('css', 'home-slider/form', 'blocks/home_slider/css_files/form.css', [], false);
        $this->requireAsset('css', 'home-slider/form');
    ...
    public function save($args) {
        ...
        $db->delete('btHomeSliderEntries', ['bID' => $this->bID]);
        ...
        if (isset($args['entry']) AND is_array($args['entry']) AND count($args['entry'])) {
            ...
            foreach ($args['entry'] as $entry) {
                ...
                $db->insert('btHomeSliderEntries', $data);
    ...
    public function composer() {
        ...
        $al = AssetList::getInstance();
        $al->register('javascript', 'home-slider/auto-js', 'blocks/home_slider/auto.js', [], false);
        $this->requireAsset('javascript', 'home-slider/auto-js');
    ...
    private function getEntries($outputMethod = 'view') {
        ...
        $sql = '
            ...
            WHERE
                btHomeSliderEntries.bID = :bID
            ORDER BY
                btHomeSliderEntries.position ASC
        ';
        $parameters = [];
        $parameters['bID'] = $this->bID;
     ...
     private function getEntryColumnNames() {
        ...
        $columns = $db->getSchemaManager()->listTableColumns('btHomeSliderEntries');
