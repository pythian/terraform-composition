 ...
 */
class AssociationEntry extends \Concrete\Core\Entity\Express\Entry\AssociationEntry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'entry', 'association', 'displayOrder'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AssociationEntry $proxy) {
