 ...
 */
class ManyToManyAssociation extends \Concrete\Core\Entity\Express\ManyToManyAssociation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'association_type', 'id', 'source_entity', 'target_entity', 'is_owned_by_association', 'is_owning_association', 'entry', 'controls', 'target_property_name', 'inversed_by_property_name'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ManyToManyAssociation $proxy) {
    ...
    public function setAssociationType($association_type)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAssociationType', [$association_type]);

        return parent::setAssociationType($association_type);
    }
