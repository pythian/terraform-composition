 ...
 */
class DateTimeValue extends \Concrete\Core\Entity\Attribute\Value\Value\DateTimeValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'value', 'generic_value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DateTimeValue $proxy) {
