 ...
 */
class BooleanValue extends \Concrete\Core\Entity\Attribute\Value\Value\BooleanValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BooleanValue $proxy) {
