 ...
 */
class SelectValue extends \Concrete\Core\Entity\Attribute\Value\Value\SelectValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'selectedOptions', 'generic_value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SelectValue $proxy) {
    ...
    public function getSelectedOptions()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSelectedOptions', []);
    ...
    public function setSelectedOptions($selectedOptions)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSelectedOptions', [$selectedOptions]);
