...
namespace DoctrineProxies\__CG__\Concrete\Core\Entity\StyleCustomizer;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CustomCssRecord extends \Concrete\Core\Entity\StyleCustomizer\CustomCssRecord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'value', 'sccRecordID'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomCssRecord $proxy) {
