 ...
 */
class ItemTag extends \Concrete\Core\Entity\Board\ItemTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'boardItemTagID', 'item', 'tag'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ItemTag $proxy) {
    ...
    public function getBoardItemTagID()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getBoardItemTagID();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBoardItemTagID', []);

        return parent::getBoardItemTagID();
    }
