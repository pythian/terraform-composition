 ...
 */
class ExpressKey extends \Concrete\Core\Entity\Attribute\Key\ExpressKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'entity', 'eakUnique', 'settings', 'akID', 'akHandle', 'akName', 'akIsSearchable', 'akIsInternal', 'akIsSearchableIndexed', 'set_keys', 'type', 'category', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExpressKey $proxy) {
    ...
    public function isAttributeKeyUnique(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isAttributeKeyUnique', []);

        return parent::isAttributeKeyUnique();
    }
    ...
    public function setIsAttributeKeyUnique(bool $eakUnique): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsAttributeKeyUnique', [$eakUnique]);

        parent::setIsAttributeKeyUnique($eakUnique);
    }
