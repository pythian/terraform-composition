 ...
 */
class DurationSettings extends \Concrete\Core\Entity\Attribute\Key\Settings\DurationSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akUnitType', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DurationSettings $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setUnitType(string $unitType): \Concrete\Core\Entity\Attribute\Key\Settings\DurationSettings
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUnitType', [$unitType]);
