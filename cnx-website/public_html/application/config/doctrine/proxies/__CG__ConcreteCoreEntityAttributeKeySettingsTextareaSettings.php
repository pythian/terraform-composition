 ...
 */
class TextareaSettings extends \Concrete\Core\Entity\Attribute\Key\Settings\TextareaSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akTextareaDisplayMode', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextareaSettings $proxy) {
