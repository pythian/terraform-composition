 ...
 */
class NewFormSubmissionNotification extends \Concrete\Core\Entity\Notification\NewFormSubmissionNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'entry', 'nID', 'nDate', 'alerts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NewFormSubmissionNotification $proxy) {
