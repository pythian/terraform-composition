 ...
 */
class EmptySettings extends \Concrete\Core\Entity\Attribute\Key\Settings\EmptySettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmptySettings $proxy) {
