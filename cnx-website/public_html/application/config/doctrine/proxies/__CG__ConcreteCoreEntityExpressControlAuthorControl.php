 ...
 */
class AuthorControl extends \Concrete\Core\Entity\Express\Control\AuthorControl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AuthorControl $proxy) {
