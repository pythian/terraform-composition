 ...
 */
class LegacyKey extends \Concrete\Core\Entity\Attribute\Key\LegacyKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LegacyKey $proxy) {
    ...
    public function getAttributeKeyIconSRC()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAttributeKeyIconSRC', []);
    ...
    public function update($args)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'update', [$args]);
