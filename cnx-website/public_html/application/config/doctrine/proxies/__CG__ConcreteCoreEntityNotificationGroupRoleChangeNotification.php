 ...
 */
class GroupRoleChangeNotification extends \Concrete\Core\Entity\Notification\GroupRoleChangeNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'groupRoleChange', 'nID', 'nDate', 'alerts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupRoleChangeNotification $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getGroupRoleChange(): \Concrete\Core\Notification\Subject\SubjectInterface
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGroupRoleChange', []);

        return parent::getGroupRoleChange();
    }
