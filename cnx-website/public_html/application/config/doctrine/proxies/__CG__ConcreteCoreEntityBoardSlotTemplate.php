 ...
 */
class SlotTemplate extends \Concrete\Core\Entity\Board\SlotTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SlotTemplate $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setHandle(string $handle): \Concrete\Core\Entity\Board\SlotTemplate
    {
     ...
     * {@inheritDoc}
     */
    public function setIcon(string $icon): \Concrete\Core\Entity\Board\SlotTemplate
    {
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \Concrete\Core\Entity\Board\SlotTemplate
    {
    ...
    public function getTemplateIconImage(bool $asTag = true)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTemplateIconImage', [$asTag]);

        return parent::getTemplateIconImage($asTag);
    }
    ...
    public function getDesignTags(): array
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDesignTags', []);

        return parent::getDesignTags();
    }

    /**
     * {@inheritDoc}
     */
    public function getDriver(): \Concrete\Core\Board\Template\Slot\Driver\DriverInterface
    {
