 ...
 */
class TextValue extends \Concrete\Core\Entity\Attribute\Value\Value\TextValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextValue $proxy) {
