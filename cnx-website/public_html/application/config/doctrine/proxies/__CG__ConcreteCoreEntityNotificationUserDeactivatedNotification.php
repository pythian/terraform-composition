 ...
 */
class UserDeactivatedNotification extends \Concrete\Core\Entity\Notification\UserDeactivatedNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'userID', 'actorID', 'nID', 'nDate', 'alerts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserDeactivatedNotification $proxy) {
    ...
    public function getActorID()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActorID', []);

        return parent::getActorID();
    }
