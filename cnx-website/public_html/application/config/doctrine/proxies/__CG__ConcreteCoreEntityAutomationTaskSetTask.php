 ...
 */
class TaskSetTask extends \Concrete\Core\Entity\Automation\TaskSetTask implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'task', 'set', 'displayOrder'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskSetTask $proxy) {
    ...
    public function getTaskSet()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTaskSet', []);

        return parent::getTaskSet();
    }
    ...
    public function setTaskSet($set)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTaskSet', [$set]);

        return parent::setTaskSet($set);
    }
