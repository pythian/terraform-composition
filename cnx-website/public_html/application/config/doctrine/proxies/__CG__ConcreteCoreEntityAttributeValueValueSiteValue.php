 ...
 */
class SiteValue extends \Concrete\Core\Entity\Attribute\Value\Value\SiteValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'site', 'generic_value'];
        }
