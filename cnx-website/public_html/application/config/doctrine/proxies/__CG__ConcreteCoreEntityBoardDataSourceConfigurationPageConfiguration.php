 ...
 */
class PageConfiguration extends \Concrete\Core\Entity\Board\DataSource\Configuration\PageConfiguration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'query', 'configurationID', 'data_source'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageConfiguration $proxy) {
