 ...
 */
class WarningFinding extends \Concrete\Core\Entity\Health\Report\WarningFinding implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WarningFinding $proxy) {
