...
namespace DoctrineProxies\__CG__\Concrete\Core\Entity\Express\Entry;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class OneAssociation extends \Concrete\Core\Entity\Express\Entry\OneAssociation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OneAssociation $proxy) {
    ...
    public function getSelectedEntry()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSelectedEntry', []);

        return parent::getSelectedEntry();
    }
    ...
    public function getSelectedEntriesCollection()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSelectedEntriesCollection', []);

        return parent::getSelectedEntriesCollection();
    }
    ...
    public function getSelectedEntries()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSelectedEntries', []);

        return parent::getSelectedEntries();
    }
    ...
    public function setSelectedEntries($selectedEntries)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSelectedEntries', [$selectedEntries]);

        return parent::setSelectedEntries($selectedEntries);
    }
