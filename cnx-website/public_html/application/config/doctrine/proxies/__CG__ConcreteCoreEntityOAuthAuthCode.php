 ...
 */
class AuthCode extends \Concrete\Core\Entity\OAuth\AuthCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'identifier', 'scopes', 'expiryDateTime', 'userIdentifier', 'client', 'redirectUri'];
        }
    ...
    public function setRedirectUri($uri)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRedirectUri', [$uri]);

        return parent::setRedirectUri($uri);
    }
