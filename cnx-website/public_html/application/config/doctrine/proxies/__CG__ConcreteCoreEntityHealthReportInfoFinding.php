 ...
 */
class InfoFinding extends \Concrete\Core\Entity\Health\Report\InfoFinding implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InfoFinding $proxy) {
