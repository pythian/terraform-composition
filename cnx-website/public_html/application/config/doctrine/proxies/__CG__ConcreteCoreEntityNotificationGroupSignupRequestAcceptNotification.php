 ...
 */
class GroupSignupRequestAcceptNotification extends \Concrete\Core\Entity\Notification\GroupSignupRequestAcceptNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupSignupRequestAcceptNotification $proxy) {
    ...
    public function getSignupRequestAccept()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSignupRequestAccept', []);

        return parent::getSignupRequestAccept();
    }
