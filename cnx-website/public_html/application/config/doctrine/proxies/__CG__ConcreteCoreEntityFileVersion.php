...
class Version extends \Concrete\Core\Entity\File\Version implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'file', 'fvID', 'fvFilename', 'fvPrefix', 'fvDateAdded', 'fvActivateDateTime', 'fvIsApproved', 'fvAuthorUID', 'fvApproverUID', 'fvSize', 'fvTitle', 'fvDescription', 'fvExtension', 'fvTags', 'fvType', 'fvHasListingThumbnail', 'fvHasDetailThumbnail', 'fvGenericType', '' . "\0" . 'Concrete\\Core\\Entity\\File\\Version' . "\0" . 'imagineImage'];
        }
    ...
    public function getGenericTypeText($includeExtension = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGenericTypeText', [$includeExtension]);

        return parent::getGenericTypeText($includeExtension);
    }
    ...
    public function buildNonpublicURLDownloadResponse()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'buildNonpublicURLDownloadResponse', []);

        return parent::buildNonpublicURLDownloadResponse();
    }
