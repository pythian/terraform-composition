 ...
 */
class OneToOneAssociation extends \Concrete\Core\Entity\Express\OneToOneAssociation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OneToOneAssociation $proxy) {
