 ...
 */
class SiteTypeValue extends \Concrete\Core\Entity\Attribute\Value\SiteTypeValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'skeleton', 'attribute_key', 'generic_value', 'attribute_value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SiteTypeValue $proxy) {
