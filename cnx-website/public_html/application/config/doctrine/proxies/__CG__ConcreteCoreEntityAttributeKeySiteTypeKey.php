 ...
 */
class SiteTypeKey extends \Concrete\Core\Entity\Attribute\Key\SiteTypeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SiteTypeKey $proxy) {
