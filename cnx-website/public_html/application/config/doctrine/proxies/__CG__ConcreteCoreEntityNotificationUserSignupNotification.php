 ...
 */
class UserSignupNotification extends \Concrete\Core\Entity\Notification\UserSignupNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserSignupNotification $proxy) {
