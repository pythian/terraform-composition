 ...
 */
class SetKey extends \Concrete\Core\Entity\Attribute\SetKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'attribute_key', 'set', 'asDisplayOrder'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SetKey $proxy) {
    ...
    public function setDisplayOrder($asDisplayOrder)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDisplayOrder', [$asDisplayOrder]);

        return parent::setDisplayOrder($asDisplayOrder);
    }
