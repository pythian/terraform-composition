 ...
 */
class Domain extends \Concrete\Core\Entity\Site\Domain implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'domainID', 'site', 'domain'];
        }
