...
//$sub_content='';
                                if ($children) {
                                    ...
                                    foreach ($children as $k => $childID) {
                                        ...
                                        <li class=" <?= $childParentName.currentPage($childID,$pageID)?>" data-id="<?=$childID?>-<?= $k+1; ?>"><a href="<?= $url ?>" target="<?=$target?>" title="<?= $child->getCollectionName(); ?>"><?= $child->getCollectionName(); ?></a>
                                          <?= $childArrow?>
...
$childName="";
            ...
            echo '<li class="'.$childName.' '.currentPage($childID,$pageID).'" ><a href="'.$url.'" target="'.$target.'" title="'.$childObj->getCollectionName().'">'.$childObj->getCollectionName().'</a>';
...
echo'<li class="'.currentPage($cchildID,$pageID).'" ><a href="'.$url.'" target="'.$target.'" title="'.$child->getCollectionName().'">'.$child->getCollectionName().'</a></li>';
