<?php namespace Application\Block\BannerHighlight;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btBannerHighlight';
    protected $btExportTables = ['btBannerHighlight', 'btBannerHighlightEntries'];
    ...
    public function addEdit() {
        ...
        $al->register('css', 'banner-highlight/form', 'blocks/banner_highlight/css_files/form.css', [], false);
        $this->requireAsset('css', 'banner-highlight/form');
    ...
    public function save($args) {
        ...
        $db->delete('btBannerHighlightEntries', ['bID' => $this->bID]);
        ...
        if (isset($args['entry']) AND is_array($args['entry']) AND count($args['entry'])) {
            ...
            foreach ($args['entry'] as $entry) {
                ...
                $db->insert('btBannerHighlightEntries', $data);
    ...
    public function duplicate($newBlockID) {
        ...
        $sql = '
            SELECT
                btBannerHighlightEntries.*
            FROM
                btBannerHighlightEntries
            WHERE
                btBannerHighlightEntries.bID = :bID
        ';
        $parameters = [];
    ...
    public function composer() {
        ...
        $al = AssetList::getInstance();
        $al->register('javascript', 'banner-highlight/auto-js', 'blocks/banner_highlight/auto.js', [], false);
        $this->requireAsset('javascript', 'banner-highlight/auto-js');
    ...
    private function getEntries($outputMethod = 'view') {
        ...
        $sql = '
            ...
            WHERE
                btBannerHighlightEntries.bID = :bID
            ORDER BY
                btBannerHighlightEntries.position ASC
        ';
        $parameters = [];
        $parameters['bID'] = $this->bID;
     ...
     private function getEntryColumnNames() {
        ...
        $columns = $db->getSchemaManager()->listTableColumns('btBannerHighlightEntries');
