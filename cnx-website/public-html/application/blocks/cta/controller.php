<?php namespace Application\Block\Cta;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btCta';
    protected $btExportTables = ['btCta'];
    ...
    public function addEdit() {
        ...
        $al->register('css', 'cta/form', 'blocks/cta/css_files/form.css', [], false);
        $this->requireAsset('css', 'cta/form');
    ...
    public function view() {
        ...
        $this->prepareForViewImage('view', [
            ...
            'thumbnail'        => true,
            'thumbnailWidth'   => !empty($this->image_data['override_dimensions']) ? (!empty($this->image_data['custom_width']) ? $this->image_data['custom_width'] : false) : 480,
            'thumbnailHeight'  => !empty($this->image_data['override_dimensions']) ? (!empty($this->image_data['custom_height']) ? $this->image_data['custom_height'] : false) : 270,
            'thumbnailCrop'    => !empty($this->image_data['override_dimensions']) ? (!empty($this->image_data['custom_crop']) ? true : false) : 1,

            'fullscreen'       => true,
            'fullscreenWidth'  => !empty($this->image_data['override_fullscreen_dimensions']) ? (!empty($this->image_data['custom_fullscreen_width']) ? $this->image_data['custom_fullscreen_width'] : false) : 1920,
            'fullscreenHeight' => !empty($this->image_data['override_fullscreen_dimensions']) ? (!empty($this->image_data['custom_fullscreen_height']) ? $this->image_data['custom_fullscreen_height'] : false) : 1080,
            'fullscreenCrop'   => !empty($this->image_data['override_fullscreen_dimensions']) ? (!empty($this->image_data['custom_fullscreen_crop']) ? true : false) : false
        ]);
    ...
    public function save($args) {
        ...
        $args['image_data'] = json_encode([
            ...
            'override_dimensions'            => !empty($args['image_override_dimensions']) ? intval($args['image_override_dimensions']) : 0,
            'custom_width'                   => !empty($args['image_custom_width']) ? intval($args['image_custom_width']) : 0,
            'custom_height'                  => !empty($args['image_custom_height']) ? intval($args['image_custom_height']) : 0,
            'custom_crop'                    => (!empty($args['image_custom_crop']) and $args['image_custom_crop']==='1' and (!(bool)$args['image_custom_width'] or !(bool)$args['image_custom_height'])) ? false : (isset($args['image_custom_crop']) ? intval($args['image_custom_crop']) : 0), // do not crop without width and height filled
            'override_fullscreen_dimensions' => !empty($args['image_override_fullscreen_dimensions']) ? intval($args['image_override_fullscreen_dimensions']) : 0,
            'custom_fullscreen_width'        => !empty($args['image_custom_fullscreen_width']) ? intval($args['image_custom_fullscreen_width']) : 0,
            'custom_fullscreen_height'       => !empty($args['image_custom_fullscreen_height']) ? intval($args['image_custom_fullscreen_height']) : 0,
            'custom_fullscreen_crop'         => (!empty($args['image_custom_fullscreen_crop']) and $args['image_custom_fullscreen_crop']==='1' and (!(bool)$args['image_custom_fullscreen_width'] or !(bool)$args['image_custom_fullscreen_height'])) ? false : (isset($args['image_custom_fullscreen_crop']) ? intval($args['image_custom_fullscreen_crop']) : 0), // do not crop without width and height filled
        ]);
