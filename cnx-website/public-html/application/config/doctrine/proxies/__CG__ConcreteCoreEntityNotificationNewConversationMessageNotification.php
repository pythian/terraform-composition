 ...
 */
class NewConversationMessageNotification extends \Concrete\Core\Entity\Notification\NewConversationMessageNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'cnvMessageID', 'nID', 'nDate', 'alerts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NewConversationMessageNotification $proxy) {
    ...
    public function getConversationMessageID(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConversationMessageID', []);
    ...
    public function getConversationMessageObject()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConversationMessageObject', []);
