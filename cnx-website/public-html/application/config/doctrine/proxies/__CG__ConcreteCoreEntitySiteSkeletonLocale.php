 ...
 */
class SkeletonLocale extends \Concrete\Core\Entity\Site\SkeletonLocale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'skeletonLocaleID', 'skeleton', 'tree', 'msLanguage', 'msCountry', 'msNumPlurals', 'msPluralRule', 'msPluralCases'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SkeletonLocale $proxy) {
    ...
    public function getSkeleton()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSkeleton', []);
    ...
    public function setSkeleton($skeleton)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSkeleton', [$skeleton]);

        return parent::setSkeleton($skeleton);
    }
