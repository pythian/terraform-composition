 ...
 */
class WorkflowProgressNotification extends \Concrete\Core\Entity\Notification\WorkflowProgressNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'wpID', 'progressObject', 'nID', 'nDate', 'alerts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkflowProgressNotification $proxy) {
    ...
    public function getWorkflowProgressObject()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWorkflowProgressObject', []);

        return parent::getWorkflowProgressObject();
    }
