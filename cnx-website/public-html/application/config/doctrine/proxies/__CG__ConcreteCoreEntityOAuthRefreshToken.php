 ...
 */
class RefreshToken extends \Concrete\Core\Entity\OAuth\RefreshToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'identifier', 'expiryDateTime', 'accessToken'];
        }
