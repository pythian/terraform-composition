...
class Entity extends \Concrete\Core\Entity\Express\Entity implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'handle', 'plural_handle', 'label_mask', 'supports_custom_display_order', 'description', 'result_column_set', 'include_in_public_list', 'is_published', 'include_in_rest_api', 'entity_results_node_id', 'use_separate_site_result_buckets', 'items_per_page', 'attributes', 'associations', 'forms', 'default_view_form', 'default_edit_form', 'entries', 'created_date', 'package'];
        }
    ...
    public function setIsPublished(bool $is_published): void
    {
        ...
        parent::setIsPublished($is_published);
    }
     ...
     * {@inheritDoc}
     */
    public function getEntryListingUrl(): \League\Url\UrlInterface
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEntryListingUrl', []);

        return parent::getEntryListingUrl();
    }
    ...
    public function getIncludeInRestApi(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIncludeInRestApi', []);

        return parent::getIncludeInRestApi();
    }
    ...
    public function setIncludeInRestApi(bool $include_in_rest_api): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIncludeInRestApi', [$include_in_rest_api]);

        parent::setIncludeInRestApi($include_in_rest_api);
    }
