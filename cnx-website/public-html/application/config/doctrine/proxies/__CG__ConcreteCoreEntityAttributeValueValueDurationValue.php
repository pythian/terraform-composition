 ...
 */
class DurationValue extends \Concrete\Core\Entity\Attribute\Value\Value\DurationValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DurationValue $proxy) {
