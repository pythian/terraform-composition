 ...
 */
class AssociationControl extends \Concrete\Core\Entity\Express\Control\AssociationControl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AssociationControl $proxy) {
    ...
    public function getAssociationEntityLabelMask()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAssociationEntityLabelMask', []);

        return parent::getAssociationEntityLabelMask();
    }
    ...
    public function setAssociationEntityLabelMask($association_entity_label_mask)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAssociationEntityLabelMask', [$association_entity_label_mask]);

        return parent::setAssociationEntityLabelMask($association_entity_label_mask);
    }
