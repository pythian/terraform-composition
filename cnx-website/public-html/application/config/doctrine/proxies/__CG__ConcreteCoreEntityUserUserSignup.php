 ...
 */
class UserSignup extends \Concrete\Core\Entity\User\UserSignup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'usID', 'user', 'notifications', 'createdBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserSignup $proxy) {
