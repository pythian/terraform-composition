 ...
 */
class Announcement extends \Concrete\Core\Entity\Announcement\Announcement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'handle', 'dateCreated'];
        }
     ...
     * {@inheritDoc}
     */
    public function getController(): \Concrete\Core\Announcement\Controller\ControllerInterface
    {
