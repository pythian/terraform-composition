 ...
 */
class CustomPageTemplateCollection extends \Concrete\Core\Entity\Page\Summary\CustomPageTemplateCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'cID', 'templates'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomPageTemplateCollection $proxy) {
