 ...
 */
class NumberValue extends \Concrete\Core\Entity\Attribute\Value\Value\NumberValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NumberValue $proxy) {
