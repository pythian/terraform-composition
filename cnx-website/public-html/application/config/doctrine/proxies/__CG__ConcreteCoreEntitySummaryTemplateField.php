 ...
 */
class TemplateField extends \Concrete\Core\Entity\Summary\TemplateField implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'is_required', 'template', 'field'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TemplateField $proxy) {
    ...
    public function setIsRequired($is_required): void
    {
        ...
        parent::setIsRequired($is_required);
    }
