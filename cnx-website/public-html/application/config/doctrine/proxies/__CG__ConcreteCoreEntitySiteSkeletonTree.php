 ...
 */
class SkeletonTree extends \Concrete\Core\Entity\Site\SkeletonTree implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'locale', 'type', 'siteTreeID', 'siteHomePageID'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SkeletonTree $proxy) {
