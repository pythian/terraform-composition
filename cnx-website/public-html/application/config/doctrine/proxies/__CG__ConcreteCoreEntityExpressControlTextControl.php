 ...
 */
class TextControl extends \Concrete\Core\Entity\Express\Control\TextControl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'headline', 'body', 'id', 'is_required', 'position', 'custom_label', 'field_set'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextControl $proxy) {
