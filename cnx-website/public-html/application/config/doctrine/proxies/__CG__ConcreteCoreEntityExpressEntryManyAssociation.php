 ...
 */
class ManyAssociation extends \Concrete\Core\Entity\Express\Entry\ManyAssociation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ManyAssociation $proxy) {
