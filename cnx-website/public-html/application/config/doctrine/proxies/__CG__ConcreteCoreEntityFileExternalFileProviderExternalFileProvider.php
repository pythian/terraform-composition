...
namespace DoctrineProxies\__CG__\Concrete\Core\Entity\File\ExternalFileProvider;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ExternalFileProvider extends \Concrete\Core\Entity\File\ExternalFileProvider\ExternalFileProvider implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'efpName', 'efpConfiguration', 'efpID'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExternalFileProvider $proxy) {
    ...
    public function setName(string $efpName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setName', [$efpName]);

        return parent::setName($efpName);
    }
