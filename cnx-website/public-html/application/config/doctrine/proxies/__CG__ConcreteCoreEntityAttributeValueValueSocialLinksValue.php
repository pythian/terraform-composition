 ...
 */
class SocialLinksValue extends \Concrete\Core\Entity\Attribute\Value\Value\SocialLinksValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'links', 'generic_value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SocialLinksValue $proxy) {
    ...
    public function getSelectedLinks()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSelectedLinks', []);

        return parent::getSelectedLinks();
    }
    ...
    public function setSelectedLinks($links)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSelectedLinks', [$links]);

        return parent::setSelectedLinks($links);
    }
