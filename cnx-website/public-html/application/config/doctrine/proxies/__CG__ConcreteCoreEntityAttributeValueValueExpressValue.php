 ...
 */
class ExpressValue extends \Concrete\Core\Entity\Attribute\Value\Value\ExpressValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'selectedEntries', 'generic_value'];
        }
