 ...
 */
class GroupSignupRequestDeclineNotification extends \Concrete\Core\Entity\Notification\GroupSignupRequestDeclineNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'signup', 'nID', 'nDate', 'alerts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupSignupRequestDeclineNotification $proxy) {
    ...
    public function getSignupRequestDecline()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSignupRequestDecline', []);

        return parent::getSignupRequestDecline();
    }
