 ...
 */
class BooleanSettings extends \Concrete\Core\Entity\Attribute\Key\Settings\BooleanSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BooleanSettings $proxy) {
    ...
    public function isCheckedByDefault()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isCheckedByDefault', []);

        return parent::isCheckedByDefault();
    }
    ...
    public function setIsCheckedByDefault($isCheckedByDefault)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsCheckedByDefault', [$isCheckedByDefault]);

        return parent::setIsCheckedByDefault($isCheckedByDefault);
    }
