 ...
 */
class TextSettings extends \Concrete\Core\Entity\Attribute\Key\Settings\TextSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akTextPlaceholder', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextSettings $proxy) {
