 ...
 */
class GroupSignupNotification extends \Concrete\Core\Entity\Notification\GroupSignupNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupSignupNotification $proxy) {
    ...
    public function getSignup()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSignup', []);

        return parent::getSignup();
    }
