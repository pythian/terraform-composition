 ...
 */
class TaskProcess extends \Concrete\Core\Entity\Command\TaskProcess implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'input', 'task', 'id', 'name', 'dateStarted', 'dateCompleted', 'exitCode', 'exitMessage', 'batch', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskProcess $proxy) {
