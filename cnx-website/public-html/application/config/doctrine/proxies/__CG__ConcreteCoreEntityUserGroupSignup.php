 ...
 */
class GroupSignup extends \Concrete\Core\Entity\User\GroupSignup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupSignup $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setGID(int $gID): \Concrete\Core\Entity\User\GroupSignup
    {
     ...
     * {@inheritDoc}
     */
    public function setUser(\Concrete\Core\Entity\User\User $user): \Concrete\Core\Entity\User\GroupSignup
    {
     ...
     * {@inheritDoc}
     */
    public function setRequested(\DateTime $requested): \Concrete\Core\Entity\User\GroupSignup
    {
