...
class Template extends \Concrete\Core\Entity\Page\Template implements \Doctrine\ORM\Proxy\Proxy
{
  ...
  'pkgID' => 0,
    ...
    public function getPageTemplateIconImage($class = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPageTemplateIconImage', [$class]);

        return parent::getPageTemplateIconImage($class);
    }
