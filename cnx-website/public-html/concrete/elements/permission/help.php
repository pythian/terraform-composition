...
<div><span class="label label-danger"><?=t('Label')?></span> <?=t('Excluded Users/Groups')?></div><br/>
<div><span class="label label-warning"><?=t('Label')?></span> <?=t('Excluded Users/Groups with timed permissions')?></div>
</div>
