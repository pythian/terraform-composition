...
<?php
$permissions = PermissionKey::getList('board_admin');
...
<?php
	...
	ccm_permissionLaunchDialog = function(link) {
		...
		jQuery.fn.dialog.open({
			...
			href: '<?=URL::to("/ccm/system/dialogs/boards/permissions", "board_admin")?>?duplicate=' + dupe + '&pkID=' + $(link).attr('data-pkID') + '&paID=' + $(link).attr('data-paID'),
			modal: true,
			width: 500,
			height: 380
		});
