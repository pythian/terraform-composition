...
$router->all('/ccm/system/express/entry/autocomplete', '\Concrete\Controller\Backend\Express\Entry\Autocomplete::view');
$router->all('/ccm/system/express/entry/autocomplete/get_selected', '\Concrete\Controller\Backend\Express\Entry\Autocomplete::getSelectedEntries');
