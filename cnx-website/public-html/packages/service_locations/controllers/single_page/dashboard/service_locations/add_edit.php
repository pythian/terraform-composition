...
class AddEdit extends DashboardPageController {
	...
	public function view() {
		...
		if(isset($_GET['ccm_order_by']) && $_GET['ccm_order_by'] && isset($_GET['ccm_order_dir']) && $_GET['ccm_order_dir']){
	...
	public function add() {
		...
		if ($this->isPost()) {
			...
			if (!$this->error->has()) {
				...
				$data = array('cName' => $this->post('pageTitle'), 'cDescription' => $this->post('pageDescription'), 'cDatePublic' => Loader::helper('form/date_time')->translate('page_date_time'));
	...
	public function update($id) {
		...
		if ($this->isPost()) {
			...
			if (!$this->error->has()) {
				...
				$data = array('pTemplateID' => $this->post('ptID'), 'ptID' => $ct->getPageTypeID(),  'cDescription' => $this->post('pageDescription'), 'cName' => $this->post('page_title'), 'cDatePublic' => Loader::helper('form/date_time')->translate('page_date_time'));
				$p->update($data);
